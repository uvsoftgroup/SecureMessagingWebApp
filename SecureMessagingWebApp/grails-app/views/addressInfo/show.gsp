...
<html>
    ...
    <body>
        ...
        <div id="show-addressInfo" class="content scaffold-show" role="main">
            ...
            <f:display bean="addressInfo" />
            <g:form resource="${this.addressInfo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.addressInfo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
