...
<html>
    ...
    <body>
        ...
        <div id="show-userRegistration" class="content scaffold-show" role="main">
            ...
            <f:display bean="userRegistration" />
            <g:form resource="${this.userRegistration}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.userRegistration}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
