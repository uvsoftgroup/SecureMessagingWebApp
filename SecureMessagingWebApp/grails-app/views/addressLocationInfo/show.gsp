...
<html>
    ...
    <body>
        ...
        <div id="show-addressLocationInfo" class="content scaffold-show" role="main">
            ...
            <f:display bean="addressLocationInfo" />
            <g:form resource="${this.addressLocationInfo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.addressLocationInfo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
