...
class ReceiverInfoControllerSpec extends Specification implements ControllerUnitTest<ReceiverInfoController>, DomainUnitTest<ReceiverInfo> {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.receiverInfoList
        model.receiverInfoCount == 0
    }
    ...
    void "Test the save action with a null instance"() {
        ...
        response.redirectedUrl == '/receiverInfo/index'
        flash.message != null
    }
    ...
    void "Test the save action correctly persists"() {
        ...
        response.redirectedUrl == '/receiverInfo/show/1'
    ...
    void "Test the show action with a valid id"() {
        ...
        model.receiverInfo instanceof ReceiverInfo
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new ReceiverInfo())
